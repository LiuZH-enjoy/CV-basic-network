...
def main():
    ...
    # 实例化SummaryWriter对象
    tb_writer = SummaryWriter(log_dir="./GoogleNetNet/runs/flower_experiment")
    ...
    image_path = os.path.join(data_root, "GoogleNet", "data_set", "flower_data")  # flower data set path
    ...
    for epoch in range(epochs):
        ...
        for step, data in enumerate(train_bar):
            ...
            train_step_loss = loss0 + loss1 * 0.3 + loss2 * 0.3
        ...
        print('[epoch %d] train_loss: %.3f validate_loss: %.3f val_accuracy: %.3f' % 
            (epoch+1, training_loss/train_steps, validate_loss/validate_steps, val_accurate))
